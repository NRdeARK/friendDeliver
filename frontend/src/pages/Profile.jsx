      ...
      <div className="flex items-center justify-center   ">
        ...
        <div className="absolute  inset-0 flex items-center justify-center flex-row">
          <div className="container bg-slate-100 h:3/5 lg:h-[450px] w-2/4  border-gray-400 rounded-[30px] drop-shadow-xl p-4 lg:flex-row  flex-col flex  items-center    ">
            ...
            <div className="basis-3/5 pr-[40px] bg-slate-300/70 rounded-[20px]  border-gray-300 flex lg:w-3/4  items-center justify-center m-2 lg:m-10">
              <div className="p-4">
            ...
            <div className="lg:absolute lg:inset-0 lg:top-[360px] xl:left-[620px] py-2 flex ms:hiddin ">
              <Logout></Logout>
            </div>
