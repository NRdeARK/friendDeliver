...
function Destination() {
  return (
    <div className='my-12 mx-24 font-[Poppins] px-32 py-16 max-xl:my-16 max-xl:mx-8'>
        ...
        <div className='flex content-center justify-between mt-16 gap-4 max-xl:flex max-xl:flex-col-reverse max-xl:mt-[2.5rem] '>
            <div className='w-2/4 text-start text-xl  max-xl:w-full'>
            ...
            <div className="relative w-1/2 flex justify-between z-0 max-xl:w-full max-xl:mx-[1.8rem] ">
                ...
                <img className=" right-0 object-cover rounded-md  absolute  max-xl:h-[250px]" 
                style={{
                    top:"-9%",
                    width:"49%",
                    height:"350px",
