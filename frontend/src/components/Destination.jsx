    ...
    <div className='xl:my-12 xl:mx-24  px-32 py-16 my-16 mx-8 '>
        ...
        <div className='flex content-center justify-between mt-16 gap-4 xl:flex-row flex-col-reverse lg:flex-row xl:mt-[2.5rem] '>
            <div className='xl:w-2/4 text-start text-xl  w-full'>
                ...
                ศูนย์รวมร้านอาหารมากมาย ทั้งอาหารตามสั่ง อาหารจานเดียว สเต็ก ก๋วยเตี๋ยว ร้านกาแฟ ผลไม้ และของหวาน บรรยากาศสบาย ๆ ราคาก็ไม่แพง        
                แถมรสชาติอาหารก็ยังถูกใจอีกด้วย และมีห้องแอร์ไว้รองรับสำหรับทานอาหารหรือนั่งพักผ่อน อ่านหนังสือกับเพื่อน ๆ ก็ได้สบาย ๆ
                </p>
            </div>
